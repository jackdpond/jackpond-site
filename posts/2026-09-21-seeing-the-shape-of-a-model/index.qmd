...
1. Bases, coordinates, and matrix-vector multiplication — [presentation](manim/1-1_coordinates_and_matrix_mult.html) | [transcript](manim/1-1_coordinates_and_matrix_mult.md)
2. The four fundamental subspaces — [presentation](manim/1-2_four_fundamental_subspaces.html) | [transcript](manim/1-2_four_fundamental_subspaces.md)
3. Linear regression as a linear transformation — [presentation](manim/2-1_regression_as_transformation.html) | [transcript](manim/2-1_regression_as_transformation.md)
4. The four fundamental subspaces in regression — [presentation](manim/2-3_linear_regression_subspaces.html) | [transcript](manim/2-3_linear_regression_subspaces.md)
